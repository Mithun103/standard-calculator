...
### Step 1:
Create a new Django project using "django-admin startproject",get into the projects terminal and use "python3 manage.y startapp" commands

### Step 2:
allow host in settings.py and add the app name under installed apps
...
## Result:
Thus the standard calculator is executed sucessfully
